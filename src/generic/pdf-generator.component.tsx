        ...
        <>
          <div className="pdf_header">
            <div className="pdf_container">
              <div
                className="pdf_container_document absolute top-0 left-4 z-140 bg-[#d3d3d3] flex m-auto justify-center"
                ref={setContainerRef}
                onResize={() => onResize}
              >
                <div className="flex flex-col grow m-auto bg-[#d3d3d3]">
                  <div className="flex justify-end flex-grow">
                    <label className="flex pt-2" onClick={() => handlePdfClose()}>
                    ...
                    <div className="hidden md:flex">
                      ...
                      <label className="flex pr-2 pt-2" onClick={() => handlePdfZoomOut()}>
